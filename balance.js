...
window.ARC_BALANCE = {
  ...
  resources: {
    nano: { name: "Nano Scrap", icon: "NS", color: "#bb9461" },
    arcane: { name: "Arcane Crystal", icon: "AC", color: "#9d73e7" },
    plasma: { name: "Plasma Core", icon: "PC", color: "#63ccdc" },
    bio: { name: "Zombie Biosample", icon: "ZB", color: "#86b36e" },
    research: { name: "Research", icon: "RP", color: "#e8b55b" }
  },
  towers: {
    sentry: {
      name: "Copper Sentry",
  ...
  stages: [
    { name: "Ashen Rail Gate", map: "single", waves: 4, types: ["shambling", "runner"], reward: { research: 20, rolls: [{ nano: 1 }] } },
    { name: "Boiler Graveyard", map: "single", waves: 5, types: ["shambling", "runner"], reward: { research: 27, rolls: [{ nano: 0.4, arcane: 0.6 }] } },
    { name: "The Copper Divide", map: "fork", waves: 6, types: ["shambling", "runner", "armored"], reward: { research: 34, rolls: [{ nano: 0.5, plasma: 0.5 }, { nano: 0.35, arcane: 0.35, plasma: 0.3 }] } },
    { name: "Sigil Refinery", map: "fork", waves: 6, types: ["runner", "armored", "mage"], reward: { research: 42, rolls: [{ arcane: 0.65, nano: 0.35 }, { nano: 0.25, arcane: 0.5, plasma: 0.25 }] } },
    { name: "Piston Necropolis", map: "crossing", waves: 7, types: ["shambling", "armored", "mage", "giant"], reward: { research: 52, rolls: [{ plasma: 0.55, nano: 0.25, arcane: 0.2 }, { nano: 0.3, arcane: 0.35, plasma: 0.35 }] } },
    { name: "Stormwork Viaduct", map: "crossing", waves: 7, types: ["runner", "armored", "mage", "giant"], reward: { research: 64, rolls: [{ arcane: 0.45, plasma: 0.4, nano: 0.15 }, { arcane: 0.45, plasma: 0.55 }] } },
    { name: "Frozen Dynamo", map: "crossing", waves: 8, types: ["shambling", "runner", "armored", "mage", "giant"], reward: { research: 78, rolls: [{ arcane: 0.4, plasma: 0.4, nano: 0.2 }, { nano: 0.2, arcane: 0.35, plasma: 0.45 }] } },
    { name: "Cathedral of Gears", map: "siege", waves: 8, types: ["armored", "mage", "giant", "runner"], reward: { research: 94, rolls: [{ nano: 0.34, arcane: 0.33, plasma: 0.33 }, { arcane: 0.48, plasma: 0.52 }, { nano: 0.25, plasma: 0.75 }] } },
    { name: "King's Black Foundry", map: "siege", waves: 9, types: ["armored", "mage", "giant", "runner"], reward: { research: 112, rolls: [{ arcane: 0.5, plasma: 0.5 }, { nano: 0.2, arcane: 0.4, plasma: 0.4 }, { nano: 0.3, plasma: 0.7 }] } },
    { name: "Throne of the Rot Engine", map: "siege", waves: 10, types: ["shambling", "runner", "armored", "mage", "giant"], reward: { research: 140, rolls: [{ nano: 0.2, arcane: 0.4, plasma: 0.4 }, { nano: 0.25, arcane: 0.35, plasma: 0.4 }, { arcane: 0.5, plasma: 0.5 }] } }
  ],
  bosses: [
