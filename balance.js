...
window.ARC_BALANCE = {
  ...
  stages: [
    { name: "Ashen Rail Gate", map: "single", waves: 4, types: ["shambling", "runner"], reward: { research: 20, rolls: [{ amount: 3, table: { nano: 1 } }] } },
    { name: "Boiler Graveyard", map: "single", waves: 5, types: ["shambling", "runner"], reward: { research: 27, rolls: [{ amount: 4, table: { nano: 0.4, arcane: 0.6 } }] } },
    { name: "The Copper Divide", map: "fork", waves: 6, types: ["shambling", "runner", "armored"], reward: { research: 34, rolls: [{ amount: 3, table: { nano: 0.5, plasma: 0.5 } }, { amount: 3, table: { nano: 0.35, arcane: 0.35, plasma: 0.3 } }] } },
    { name: "Sigil Refinery", map: "fork", waves: 6, types: ["runner", "armored", "mage"], reward: { research: 42, rolls: [{ amount: 4, table: { arcane: 0.65, nano: 0.35 } }, { amount: 3, table: { nano: 0.25, arcane: 0.5, plasma: 0.25 } }] } },
    { name: "Piston Necropolis", map: "crossing", waves: 7, types: ["shambling", "armored", "mage", "giant"], reward: { research: 52, rolls: [{ amount: 4, table: { plasma: 0.55, nano: 0.25, arcane: 0.2 } }, { amount: 4, table: { nano: 0.3, arcane: 0.35, plasma: 0.35 } }] } },
    { name: "Stormwork Viaduct", map: "crossing", waves: 7, types: ["runner", "armored", "mage", "giant"], reward: { research: 64, rolls: [{ amount: 5, table: { arcane: 0.45, plasma: 0.4, nano: 0.15 } }, { amount: 4, table: { arcane: 0.45, plasma: 0.55 } }] } },
    { name: "Frozen Dynamo", map: "crossing", waves: 8, types: ["shambling", "runner", "armored", "mage", "giant"], reward: { research: 78, rolls: [{ amount: 5, table: { arcane: 0.4, plasma: 0.4, nano: 0.2 } }, { amount: 5, table: { nano: 0.2, arcane: 0.35, plasma: 0.45 } }] } },
    { name: "Cathedral of Gears", map: "siege", waves: 8, types: ["armored", "mage", "giant", "runner"], reward: { research: 94, rolls: [{ amount: 5, table: { nano: 0.34, arcane: 0.33, plasma: 0.33 } }, { amount: 5, table: { arcane: 0.48, plasma: 0.52 } }, { amount: 4, table: { nano: 0.25, plasma: 0.75 } }] } },
    { name: "King's Black Foundry", map: "siege", waves: 9, types: ["armored", "mage", "giant", "runner"], reward: { research: 112, rolls: [{ amount: 6, table: { arcane: 0.5, plasma: 0.5 } }, { amount: 5, table: { nano: 0.2, arcane: 0.4, plasma: 0.4 } }, { amount: 5, table: { nano: 0.3, plasma: 0.7 } }] } },
    { name: "Throne of the Rot Engine", map: "siege", waves: 10, types: ["shambling", "runner", "armored", "mage", "giant"], reward: { research: 140, rolls: [{ amount: 7, table: { nano: 0.2, arcane: 0.4, plasma: 0.4 } }, { amount: 6, table: { nano: 0.25, arcane: 0.35, plasma: 0.4 } }, { amount: 6, table: { arcane: 0.5, plasma: 0.5 } }] } }
  ],
  bosses: [
  ...
  fortress: {
    armor: { name: "Aegis Frame", max: 8, hpPerLevel: 32, costs: { nano: 2, research: 20 } },
    plasma: { name: "Plasma Bulwark", max: 8, shieldPerLevel: 30, cooldown: 9, costs: { plasma: 2, research: 26 } },
    critical: { name: "Critical Matrix", max: 8, chancePerLevel: 0.045, damagePerLevel: 0.22, costs: { arcane: 2, research: 30 } },
    special: { name: "Special Ability Slot", max: 3, costs: { bio: 18, research: 50 } }
  },
  guns: {
